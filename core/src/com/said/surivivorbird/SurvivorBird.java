package com.said.surivivorbird;
...
public class SurvivorBird extends ApplicationAdapter {
	...
	@Override
	public void render() {  //Oyun devam ettiği müddetçe gerçekleşen olaylar burada yazılır.
		...
		for(int i=0;i<numberOfEnemies;i++){
			...
			batch.draw(bee3,enemyX[i],320,Gdx.graphics.getWidth()/15,Gdx.graphics.getHeight()/10);
		}
